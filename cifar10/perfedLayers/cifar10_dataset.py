...
def load_cifar10_federated(
    dirichlet_parameter: float = 0.2,
    #dirichlet_parameter: float = 10e15,
    num_clients: int = 10,
) -> Tuple[tff.simulation.FromTensorSlicesClientData,
...
def get_federated_datasets(num_clients: int = 10,
  ...
  cifar_train, cifar_test = load_cifar10_federated(num_clients=num_clients)
